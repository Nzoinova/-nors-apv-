  ...
  return (
    <div className="space-y-6 max-w-xl">
      ...
      <div className="bg-white rounded-lg border border-gray-200 shadow-sm p-5 space-y-4">
        <h2 className="text-sm font-semibold uppercase tracking-wider text-gray-500">Taxa de Câmbio</h2>

        <div className="flex items-center justify-between">
          <div>
            <p className="text-2xl font-bold text-nors-teal">
              {config ? formatNumber(config.taxa_cambio_usd_kz) : '—'} <span className="text-sm font-light text-gray-500">KZ/USD</span>
            </p>
        ...
        <div className="flex gap-3">
          <input
            ...
            className="flex-1 h-11 px-3 rounded-lg border border-gray-200 text-sm focus:outline-none focus:border-nors-teal focus:ring-1 focus:ring-nors-teal/20"
          />
          <button
      ...
      {/* Parâmetros */}
      <div className="bg-white rounded-lg border border-gray-200 shadow-sm p-5 space-y-4">
        <h2 className="text-sm font-semibold uppercase tracking-wider text-gray-500">Parâmetros de Alerta</h2>

        <div className="space-y-3 text-sm">
          <div className="flex justify-between py-2 border-b border-gray-100">
            <span className="text-gray-500">Intervalo entre revisões</span>
            <span className="font-semibold">{config?.intervalo_dias_revisao} dias</span>
          </div>
          <div className="flex justify-between py-2 border-b border-gray-100">
            <span className="text-gray-500">Alerta de renovação</span>
            <span className="font-semibold">{config?.alerta_renovacao_dias} dias antes</span>
          </div>
          <div className="flex justify-between py-2">
            <span className="text-gray-500">Alerta de revisão</span>
